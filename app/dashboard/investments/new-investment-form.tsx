...
export default function NewInvestmentForm({ leadOptions }: { leadOptions: LeadOption[] }) {
  ...
  return (
    ...
    >
      <div className="flex w-72 flex-col gap-1.5">
        <label className="text-sm font-medium text-neutral-700">Nouveau projet — prospect concerné</label>

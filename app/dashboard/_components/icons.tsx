// Petit jeu d'icônes ligne (style Lucide, sous licence ISC — tracés repris
// tels quels) utilisées par le menu latéral principal (voir
// app/dashboard/sidebar-nav.tsx). Intégrées ici en SVG local plutôt que via
// la bibliothèque lucide-react pour éviter d'ajouter une dépendance npm —
// et le fichier package-lock.json que ça implique de déposer — pour 19
// icônes fixes qui ne changeront pas souvent.
...
// Bouton "ouvrir le menu" du tiroir de navigation mobile (voir
// app/dashboard/mobile-nav.tsx).
...
// Bouton "fermer" du tiroir de navigation mobile.
